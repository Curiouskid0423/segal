...
active_learning = dict(
    settings = dict(
        pixel = dict(      
            budget_per_round=int(256*512*0.001) * 2975,           
            initial_label_pixels=int(256*512*0.001) * 2975,
            sample_evenly=True,
            ignore_index=255,
        ),
    ),
...
checkpoint_config = dict(by_epoch=True, interval=1*50)
