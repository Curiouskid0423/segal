...
workflow = [(('train', 2), ('query', 1)) for _ in range(20)] + [(('train', 3),)]
runner = dict(type='MultiTaskActiveRunner', sample_mode="region", sample_rounds=20)
...
active_learning = dict(
    ...
    visualize = dict(
        ...
        dir="visualizations/n2a_mps_r20_ripu+mps_linear_strong-init"),
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs = dict(
                ...
                group   = 'aaai',
                name    = f'n2a_mps_r20_ripu+mps_linear_strong-init',
            )
        )
    ]
)
