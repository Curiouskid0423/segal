...
load_from = '/shared/yutengli/segal/work_dirs/warmup_acdc/iter_1000.pth'
...
active_learning = dict(
    ...
    visualize = dict(
        ...
        dir="visualizations/n2a_lr-mult-enc02_warmup1000"),
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs = dict(
                ...
                group   = 'aaai',
                name    = f'n2a_lr-mult-enc02_warmup1000_acdc-init',
            )
        )
    ]
)
