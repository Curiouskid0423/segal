...
HEURISTICS = "ripu"
VIZ_SIZE = 20
work_dir = './work_dirs/multitask_ra_lr5e-4_m50_1500warmup_e35'
    ...
    hooks=[ 
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name=f'almma_vit-b16_mae-IN1k-init_multitask_ra_batch16_1500warmup_e35',
            )
        )
    ]
)
...
active_learning = dict(
    ...
    visualize = dict(
        size=VIZ_SIZE,
        overlay=True,
        dir="visualizations/multitask_ra_lr5e-4_m50_1500warmup_e35"
    ),
    heuristic_cfg=dict(
        k=1,
        use_entropy=True,
